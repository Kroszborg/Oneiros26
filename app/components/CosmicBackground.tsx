...
const LAYER_CONFIGS = [
  { count: 300, sizeMin: 0.6, sizeMax: 1.8, duration: 120, opacity: 0.85 },
  { count: 175, sizeMin: 1.2, sizeMax: 3.2, duration: 180, opacity: 0.6 },
  { count: 100, sizeMin: 2.0, sizeMax: 4.5, duration: 240, opacity: 0.4 },
];
