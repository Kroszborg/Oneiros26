      ...
      >
        ...
        >
          <Image
            ...
            fill
            style={{ objectFit: "cover", filter: "brightness(0.88) contrast(1.05)" }}
            loading="lazy"
  ...
  return (
    <div className="major-events-page" style={{ minHeight: "100vh", position: "relative" }}>
      ...
      <Image
        ...
        width={480}
        height={480}
        style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: "min(60vw,480px)", height: "auto", opacity: 0.09, filter: "blur(2px) brightness(1.3)", pointerEvents: "none", zIndex: 0 }}
        loading="lazy"
        aria-hidden="true"
      />
